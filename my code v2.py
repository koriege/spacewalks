...
data_f = open('/home/kriege/tmp/cecam/astronaut-data-analysis-not-so-fair/data.json', 'r')
data_t = open('/home/kriege/tmp/cecam/astronaut-data-analysis-not-so-fair/data.csv','w')
g_file = 'myplot.png'
